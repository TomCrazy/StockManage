...
namespace nsStockManage
{
    class MenuStrip
    {
        ...
        public void 终端管理ToolStripMenuItem_Click()
        {
            ...
            Program.mw.toolStripButton1.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\client.ico");
            Program.mw.toolStripButton2.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\exit.ico");
        ...
        public void 工装入库ToolStripMenuItem_Click()
        {
            ...
            Program.mw.toolStripButton1.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\return.ico");
            Program.mw.toolStripButton2.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\newToolsIn.ico");
            Program.mw.toolStripButton3.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\repair1.ico");
        }
        //工装出库
        public void 工装出库ToolStripMenuItem_Click()
        {
            ...
            Program.mw.toolStripButton3.Text = "";
            Program.mw.toolStripButton1.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\tools.ico");
            Program.mw.toolStripButton2.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\TV1.ico");
        }
        ...
        public void 库位管理ToolStripMenuItem_Click()
        {
            ...
            Program.mw.toolStripButton1.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\shelf.ico");
            Program.mw.toolStripButton2.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\change.ico");
            Program.mw.toolStripButton3.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\lookup.ico");
        }
        ...
        public void 数据管理ToolStripMenuItem_Click()
        {
            ...
            Program.mw.toolStripButton3.Text = "";
            Program.mw.toolStripButton1.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\toolsData1.ico");
            Program.mw.toolStripButton2.Image = new Bitmap(System.Windows.Forms.Application.StartupPath + "\\machine.ico");
